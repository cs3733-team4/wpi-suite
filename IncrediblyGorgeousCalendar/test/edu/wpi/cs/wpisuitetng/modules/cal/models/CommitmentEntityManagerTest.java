...
public class CommitmentEntityManagerTest {
        ...
        Commitment e = new Commitment().addStartTime(one).addName("First");
        String eString=e.toJSON();
        
        Commitment ee=new Commitment().addStartTime(two).addName("Second");
        String eeString=ee.toJSON();
        
        Commitment eee=new Commitment().addStartTime(three).addName("Third");
